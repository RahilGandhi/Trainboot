      ...
      <section className="grid grid-cols-[250px_1fr]">
        ...
        <section className="bg-grey-primary">
          ...
          <div className="py-4 px-8">
            ...
            >
              <h1 className="text-2xl">Create new Training</h1>
              ...
              <div className="grid grid-cols-2 gap-x-3">
                <div className="flex flex-col gap-y-1">
                  <label htmlFor="ins" className="text-gray-600">
                    Instructor
                  </label>
                  <input
                    type="text"
                ...
                <div className="flex flex-col gap-y-1">
                  <label htmlFor="thumb" className="text-gray-600">
                    Thumbnail
                  </label>
                  <input
                    type="text"
              ...
              <div className="flex flex-col gap-y-1">
                <label htmlFor="src" className="text-gray-600">
                  Source
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col gap-y-1">
                <label htmlFor="summary" className="text-gray-600">
                  Summary
                </label>
                <textarea
                  rows={5}
